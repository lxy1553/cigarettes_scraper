...
> ⚠️ **每支用丝量确认中：**
> - 旧值：0.7g/支（20支=14g），密度约 0.62 g/cm³
> - 建议值：0.333g/支（20支=6.66g），密度约 0.29 g/cm³（偏松）
> - 实际手卷烟密度通常在 0.4~0.6 g/cm³，对应 0.45~0.68g/支
>
> 请确认你实际使用的烟丝量，确定后在 README 中更新。

```
每支烟丝成本    = 每支用丝量g × 克单价
20支烟丝成本   = 20 × 每支用丝量g × 克单价
20支成品成本   = 20支烟丝成本 + 耗材成本(纸+滤嘴)
```
